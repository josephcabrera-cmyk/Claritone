/**
  ...
  ******************************************************************************
  *
  * Modified for NUCLEO-N657X0-Q test platform
  * I2C1 on PH9 (SCL) / PC1 (SDA), single VL53L7CX SATEL sensor
  *
  ******************************************************************************
  */
...
/*
 * STM32N6 HAL — required for I2C_HandleTypeDef and GPIO types.
 * If your project uses a different top-level include, change this line.
 */
...
typedef struct
{
	/* I2C address of this sensor (8-bit format, default 0x52) */
	uint16_t             address;

	/* HAL I2C peripheral handle (I2C1 for Claritone ToF bus) */
	I2C_HandleTypeDef   *hi2c;

	/* Per-sensor GPIO control lines */
	GPIO_TypeDef        *lpn_port;      /* LPn — low disables I2C comms   */
	uint16_t             lpn_pin;

	GPIO_TypeDef        *int_port;      /* INT — data-ready interrupt     */
	uint16_t             int_pin;

	GPIO_TypeDef        *rst_port;      /* I2C_RST — resets I2C state     */
	uint16_t             rst_pin;
